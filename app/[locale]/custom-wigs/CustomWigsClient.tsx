...
export default function CustomWigsPage() {
  const t = useTranslations('customWigs');
    ...
    <div className="pt-28 pb-20">
      ...
      <div className="relative h-[50vh] flex items-center justify-center overflow-hidden mb-20">
        <div className="absolute inset-0">
          ...
          <img src="/images/perika-ombre-platinum.jpg" alt="Custom Wigs" className="w-full h-full object-cover" />
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8">
        ...
        >
          <p className="text-muted text-lg leading-relaxed mb-8">{t('description')}</p>
        </motion.div>
          ...
          {['step1', 'step2', 'step3', 'step4'].map((key, i) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <span className="w-10 h-10 border border-accent/30 rounded-full flex items-center justify-center text-accent font-serif font-bold">
                  {i + 1}
                </span>
                <h3 className="font-serif text-xl font-semibold text-accent">{t(`${key}Title`)}</h3>
              </div>
