          ...
          <div className="p-3 border-t border-[#2a2a2a]">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-[#1a1a1a] border border-[#2a2a2a] rounded-full px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#C9A96E]/50 transition-colors"
              />
              <button
                onClick={handleSend}
